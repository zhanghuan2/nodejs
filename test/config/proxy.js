...
module.exports = {
  ...
  rules: {
    ...
    mall: {
      host: `https://${domain}`,
      useMock: ['/decorate/decorate/sites/templates'],
      urls: [
        '/decorate/*',
      ],
    },
    admin: {
      ...
      useMock: ['/operating/inspection/bench/next/item/info','/user/apps/getAppsBasicInfo', '/user/privileges/getAppMenuTree', '/backlog/*'],
    },
    // middle
    middle: {
      host: `http://middle.${domain}`,
      useMock: ['/user/apps/getAppsBasicInfo', '/user/privileges/getAppMenuTree', '/backlog/*'], // boolean or string[] eg: true or ['/api/*']
      urls: [
        '/api/*',
        '/user/*',
        '/district/*',
        ...
        '/operating/inspection/result/get',
        '/operating/common/district/top',
        '/operating/*',
      ],
    },
